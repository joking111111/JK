...
public abstract class BaseSetupActivity extends AppCompatActivity {
        ...
        mDectector = new GestureDetector(this, new SimpleOnGestureListener() {
            ...
            public boolean onFling(MotionEvent e1, MotionEvent e2,
                ...
                if (Math.abs(e2.getRawY() - e1.getRawY()) > 100) {
                    ToastUtils.showShortToast(BaseSetupActivity.this, "不能这样划哦!");
                    return true;
                }

                // 判断滑动是否过慢
                if (Math.abs(velocityX) < 100) {
                    ToastUtils.showShortToast(BaseSetupActivity.this, "滑动的太慢了!");
                    return true;
                }
    ...
    /**
     * IllegalStateException  按钮onClick 必须有参数View view！！！
     * 子类Button onClick
     */
