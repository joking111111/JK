...
import com.joking.jk.bean.BlackNumberInfo;
import com.joking.jk.db.dao.BlackNumberDao;
...
public class CallSmsSafeActivity extends BaseActivity {
    ...
    private void initViews() {
        setContentView(R.layout.activity_call_safe);//分批加载
                    ...
                    case AbsListView.OnScrollListener.SCROLL_STATE_IDLE:
                        ...
                        if (lastVisiblePosition == blackNumberInfos.size() - 1) {
                            ...
                            if (mStartIndex >= totalNumber) {
                                ToastUtils.showShortToast(CallSmsSafeActivity.this, "没有更多的数据了");
                                return;
                            }
                            initData();
                        }
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(str_number)) {
                    ToastUtils.showShortToast(CallSmsSafeActivity.this, "请输入黑名单号码");
                    return;
                }
                ...
                if (cb_phone.isChecked() && cb_sms.isChecked()) {
                    ...
                    ToastUtils.showShortToast(CallSmsSafeActivity.this, "请勾选拦截模式");
                    return;
                }
    ...
    private class CallSafeAdapter extends BaseAdapter {
        ...
        private CallSafeAdapter(List<BlackNumberInfo> blackNumberInfos) {
            mBlackNumberInfos = blackNumberInfos;
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            if (convertView == null) {
                convertView = View.inflate(CallSmsSafeActivity.this, R.layout.call_safe_list_item, null);
            ...
            holder.tv_number.setText(mBlackNumberInfos.get(position).getNumber());
            ...
            final BlackNumberInfo info = mBlackNumberInfos.get(position);
            holder.iv_delete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (result) {
                        ToastUtils.showShortToast(CallSmsSafeActivity.this, "删除成功");
                        mBlackNumberInfos.remove(info);
                        //刷新界面
                        adapter.notifyDataSetChanged();
                    } else {
                        ToastUtils.showShortToast(CallSmsSafeActivity.this, "删除失败");
                    }
                }
            });
            return convertView;
